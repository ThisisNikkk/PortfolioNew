...
(function () {
    var header = $('.js-header'),
        ...
        html = $('html'),
        body = $('body'),
        links = $('.js-header-wrapper .js-scroll'); // Get the nav links

    // This part handles the burger click
...
// scroll to section
(function () {
    // Selects both the original scroll buttons AND the links in the header navigation
    var btn = $('.js-scroll, .header__nav a'); // <-- Ise update karein
    btn.click(function () {
        $("html, body").animate({
